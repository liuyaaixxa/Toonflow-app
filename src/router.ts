// @routes-hash bd991d81e0037d2927c5972f7b52e48c
...
import route33 from "./routes/plan/getPlans";
import route34 from "./routes/plan/getUserPlan";
import route35 from "./routes/plan/subscribe";
...
import route39 from "./routes/project/getProjectCount";
import route40 from "./routes/project/getSingleProject";
import route41 from "./routes/project/updateProject";
import route42 from "./routes/prompt/getPrompts";
import route43 from "./routes/prompt/updatePrompt";
import route44 from "./routes/script/generateScriptApi";
import route45 from "./routes/script/generateScriptSave";
import route46 from "./routes/script/geScriptApi";
import route47 from "./routes/setting/addModel";
import route48 from "./routes/setting/configurationModel";
import route49 from "./routes/setting/delModel";
...
export default async (app: Express) => {
  ...
  app.use("/plan/getPlans", route33);
  app.use("/plan/getUserPlan", route34);
  app.use("/plan/subscribe", route35);
  app.use("/project/addProject", route36);
  app.use("/project/delProject", route37);
  app.use("/project/getProject", route38);
  app.use("/project/getProjectCount", route39);
  app.use("/project/getSingleProject", route40);
  app.use("/project/updateProject", route41);
  app.use("/prompt/getPrompts", route42);
  app.use("/prompt/updatePrompt", route43);
  app.use("/script/generateScriptApi", route44);
  app.use("/script/generateScriptSave", route45);
  app.use("/script/geScriptApi", route46);
  app.use("/setting/addModel", route47);
  app.use("/setting/configurationModel", route48);
  app.use("/setting/delModel", route49);
