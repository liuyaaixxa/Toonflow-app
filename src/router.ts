// @routes-hash e6fe914417257d628f4f8be238e84eca
...
import route12 from "./routes/novel/createNovel";
...
import route34 from "./routes/plan/getPlans";
import route35 from "./routes/plan/getUserPlan";
import route36 from "./routes/plan/subscribe";
...
import route40 from "./routes/project/getProjectCount";
import route41 from "./routes/project/getSingleProject";
import route42 from "./routes/project/updateProject";
import route43 from "./routes/prompt/getPrompts";
import route44 from "./routes/prompt/updatePrompt";
import route45 from "./routes/script/generateScriptApi";
import route46 from "./routes/script/generateScriptSave";
import route47 from "./routes/script/geScriptApi";
import route48 from "./routes/setting/addModel";
import route49 from "./routes/setting/configurationModel";
import route50 from "./routes/setting/delModel";
import route51 from "./routes/setting/getAiModelMap";
import route52 from "./routes/setting/getLog";
...
export default async (app: Express) => {
  ...
  app.use("/novel/createNovel", route12);
  ...
  app.use("/plan/getPlans", route34);
  app.use("/plan/getUserPlan", route35);
  app.use("/plan/subscribe", route36);
  app.use("/project/addProject", route37);
  app.use("/project/delProject", route38);
  app.use("/project/getProject", route39);
  app.use("/project/getProjectCount", route40);
  app.use("/project/getSingleProject", route41);
  app.use("/project/updateProject", route42);
  app.use("/prompt/getPrompts", route43);
  app.use("/prompt/updatePrompt", route44);
  app.use("/script/generateScriptApi", route45);
  app.use("/script/generateScriptSave", route46);
  app.use("/script/geScriptApi", route47);
  app.use("/setting/addModel", route48);
  app.use("/setting/configurationModel", route49);
  app.use("/setting/delModel", route50);
  app.use("/setting/getAiModelMap", route51);
  app.use("/setting/getLog", route52);
